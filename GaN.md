...
## 14.3 洞察：中国功率宽带隙半导体的崛起 Techinsights

关键要点：中国在宽带隙制造领域占据主导地位
2024年，全球SiC原始晶圆产能超过400万片6英寸当量，这主要得益于SICC、Summit Crystal、SemiSiC、Synlight、Tankeblue等中国生产商的大力扩张。与此同时，包括Wolfspeed、安森美半导体（通过GT Advanced）、罗姆（通过SiCrystal）、意法半导体（拥有Norstel资产）和三安半导体在内的多家垂直整合企业继续扩大其内部晶圆制造能力。

与此同时，加工后的SiC晶圆供应与电力电子市场的需求保持着密切联系（市场数据：功率SiC），随着行业向8英寸晶圆直径过渡，到2024年，其产量将达到约230万片6英寸当量晶圆。在设备升级和新生产线的支持下，向更大晶圆的转变提高了晶圆的均匀性，降低了缺陷率，并提升了整体生产率。

然而，随着电动汽车市场增长放缓，SiC晶圆制造扩张的步伐也在放缓。一些公司正在缩减其产能扩张计划；例如，Wolfspeed 正在关闭其位于达勒姆的 6 英寸晶圆厂，英飞凌正在推迟其居林扩建的第二阶段，安森美半导体则暂停了对其富川工厂的投资。这种减速正在抵消此前由去全球化推动的势头，而去全球化曾是产能增长的主要驱动力。

预计重点将从积极的产能建设转向优化现有资产和提高产量，尤其是在 8 英寸生产线上。中期前景可能以谨慎和重新评估扩张计划为特征。监测电动汽车、工业和可再生能源应用中对 SiC 的结构性需求将是关键，尤其是在去全球化和弹性供应链建设的背景下。图 1 概述了全球现有和计划中的半导体制造生产线的已安装和预期 SiC 晶圆产能。该图表表示工厂位置。总体而言，预计 6 英寸晶圆的产量将稳定在每月 350,000 片左右。到 2029 年，我们预计 8 英寸 SiC 芯片的产量将与目前的 6 英寸晶圆产量相匹配。目前，中国占全球 SiC 产能的 30%，其次是欧洲（21%）、美国（14%）、日本（14%）和韩国（12%）。台湾和其他亚洲国家/地区占据剩余产能。产能扩张的演变很大程度上取决于市场发展和关税的影响。有扩张计划的功率半导体公司可能会等待即将出台的新贸易规则明确后，相应地调整其制造布局战略。与此同时，建立工厂或生产线需要24至36个月的时间，从建筑施工到工具安装和认证，需要精心规划。

![](/picture/sic%20wafer.png)
图 1 – 各地区和直径的 SiC 晶圆产能（千片/月）

GaN 的情况则截然不同。主要的产能限制在于如何在硅或蓝宝石等异质衬底上实现高质量的外延，因为体 GaN 的供应尚不成熟。与 SiC 不同，GaN 器件主要采用横向结构，从而简化了工艺集成。硅基 GaN (GaN-Si) 也受益于与现有硅晶圆厂的兼容性，从而降低了资本密集度。

然而，硅基异质外延生长带来了诸多挑战，例如晶圆翘曲、应力和高位错密度，这些挑战会随着晶圆直径的增加而加剧。与SiC相比，外延是GaN的关键工艺步骤，各公司通常将其作为内部知识产权组合的一部分保留。像QST这样的工程衬底有助于解决翘曲问题，而且价格昂贵。与此同时，设备供应商也取得了重大进展。温度梯度控制、气流均匀性以及预热和冷却室的优化改进，改善了更大晶圆的应力管理、厚度均匀性和缺陷率。

这些改进现在使 8 英寸晶圆的产能扩张成为可能，并为向 12 英寸过渡奠定了基础。例如，Innoscience 已在 8 英寸晶圆上量产增强型 GaN；英飞凌已经证明了 12 英寸规模 GaN 的可行性；德州仪器计划通过在其会津晶圆厂提高 8 英寸产量（完全转移到 12 英寸）来将其 GaN 产量翻两番。这些举措旨在为 GaN 的下一波增长做好准备，正如我们在《2025 年功率半导体的五大关键趋势》中所讨论的那样。图 2 概述了全球现有和计划中的半导体生产线的已安装和预期 GaN 晶圆产能。8 英寸晶圆已经成为主流基板，中国在该领域的主导地位甚至比在 SiC 生产方面更为明显。虽然12英寸GaN技术尚处于发展初期，但我们预计到2028年它将占到全球总产量的10%。2024年，中国大陆的GaN晶圆制造产能将占全球产能的57%，其次是台湾地区（14%）、日本（11%）、欧洲（10%）和美国（4%）。8英寸产能的庞大或许是中国领先的GaN制造商英诺赛克（Innoscience）在功率GaN市场占据主导地位的原因之一。例如，TechInsights在意法半导体（STMicroelectronics）的VIPerGaN65D高压转换器上发现了英诺赛克的GaN芯片。

![](/picture/gan%20wafer.png)
图 2 – 每个区域和直径的 GaN 晶圆产能，单位：千片晶圆/月

关键意义：战略投资与市场需求相一致
向 8 英寸晶圆的转变是 SiC 和 GaN 技术实现规模化的关键推动因素。虽然更大的晶圆会加剧诸如弯曲和缺陷扩展等挑战，但 8 英寸设备平台的最新进展在工艺均匀性、缺陷控制和整体生产率方面带来了切实的提升。这些改进对于降低成本和提高单晶圆良率至关重要。

但晶圆微缩不仅仅是一个技术里程碑，更是全球供应链的转折点。在新冠疫情危机导致芯片短缺之后，化合物半导体生态系统的地域分布更加分散。从可用产能来看，中国已成为宽带隙 (WBG) 制造业的主导力量，这得益于两大关键驱动力：电动汽车、可再生能源和工业应用领域的强劲国内需求，以及明确的战略政策，该政策将对国内龙头企业的直接资助与对外国合资企业的激励措施相结合，例如意法半导体与三安在碳化硅领域的合作。这些合作有助于确保短期市场准入，但也有可能巩固中国的长期领导地位，同时使西方公司面临潜在的知识产权诉讼。我们的晶圆制造设备 (WFE) 区域设备销售市场数据证实，大量对晶圆制造设备 (WFE) 的投资流向了中国，2024 年中国约占总销售额的 37%。

从收入角度来看，情况正好相反。根据我们的功率半导体市场份额数据，中国企业在功率半导体市场（包括宽带隙技术）中仍然只占较小份额，仅次于欧洲、北美和日本企业。然而，他们的份额正在稳步增长，并在供应链中占据主导地位，并获得了颇具挑战性的汽车级认证。

半导体供应链投资是一个复杂的过程，受一系列战略因素驱动，包括能否获得经济可靠的能源、可持续的水资源、关键原材料的接近性、当地生态系统的成熟度（从工具供应商到人才渠道）、地缘政治稳定性、劳动力成本，以及最重要的市场需求。虽然成本优势依然重要，但长期竞争力越来越取决于生态系统的深度、创新能力以及与终端市场需求的契合度。在此背景下，北美和欧洲的主要电动汽车和消费市场都不容忽视。图3概述了宽带隙制造中心以及一些当地市场需求的形成原因。

![](/picture/wideband%20factory.png)
图 3 – 宽带隙制造足迹

那些将关税、贸易限制和报复措施视为战略调整催化剂而非威胁的企业，将最有可能引领行业发展。通过密切追踪世界银行集团区域市场动态并相应地调整投资策略，这些企业能够将地缘政治摩擦转化为长期增长的引擎。

<https://library.techinsights.com/hg-asset/a3cc1aec-6d0e-4bf6-80f2-d67df6976430#moduleName=Search&reportCode=PWS-2502-901&subscriptionId=null&channelId=null&reportName=Insights%253A+China%25E2%2580%2599s+Rise+in+Power+Wide+Bandgap+Semiconductors>

## 14.4 TSMC

### 14.4.1 台积电计划退出，Navitas 将 GaN 生产转移至 PSMC

纳微半导体 (Navitas Semiconductor) 宣布与台湾晶圆代工厂力晶半导体制造股份有限公司 (PSMC) 建立战略合作伙伴关系，启动 200 毫米硅基氮化镓 (GaN-on-silicon) 技术的生产并推进其开发。

根据此次合作，纳微的GaN IC产品组合将在力晶位于竹南科技园区的晶圆厂8B厂生产，采用力晶180纳米分立式工艺流程。力晶正在积极开发该节点的100V、200V和650V GaN平台，力争成为不断发展的GaN供应链中的关键参与者。

100V GaN系列预计将于2026年上半年投产。与此同时，650V器件将在未来12至24个月内逐步从纳微目前的供应商台积电过渡到力晶。纳微正在评估其他采购渠道，以确保其运营。

此次转变发生之际，台积电已告知 Navitas 其打算在 2027 年 7 月之前停止 GaN 生产。TechInsights 的行业分析师早在 4 月份就已观察到客户脱离台积电 GaN 业务的早期迹象，尤其是意法半导体与 Innoscience 签订的 GaN 供应和开发协议。

GaN技术仍然是纳微（Navitas）和其他无晶圆厂功率半导体公司的基石。台积电退出GaN市场既带来了挑战，也带来了机遇。尽管台积电仍在其6英寸生产线上生产GaN器件，但整个行业正在迅速向8英寸晶圆过渡，这可能会削弱台积电GaN业务的战略价值。

这种供应链的转变为其他代工厂的介入打开了大门。例如，瑞萨电子已宣布与Polar Semiconductor合作，共同开发其下一代d型GaN。在中国，AMSfab、三安集成电路和华润微电子旗下的润芯微正在加速其GaN研发，而德州仪器和英飞凌等主要IDM厂商正在提升内部GaN产能。
2024年12月，罗姆半导体与台积电就汽车行业GaN产品启动了战略合作。罗姆可能是下一个宣布其GaN产品线获得批准的公司。

随着 GaN 生态系统的发展，战略代工合作伙伴关系对于塑造 GaN 电力电子的下一阶段至关重要。

<https://library.techinsights.com/sectioned-blog-viewer/16680dab-2b0e-4f8d-8ab9-521d12516b19>

### 14.4.2 台积电退出GaN市场的5个原因

作者：Mark LaPedus

出人意料的是，台积电计划在 2027 年退出氮化镓 (GaN) 代工业务。

此举将影响台积电的几家长期GaN代工客户，包括纳微（Navitas）、罗姆（Rohm）和意法半导体（STMicroelectronics）。这些公司以及其他公司的GaN芯片此前均由台积电代工。现在，他们需要寻找新的制造合作伙伴来生产用于电力电子、射频（RF）和其他专业应用的GaN器件。

Navitas 和意法半导体都已填补了这一空白，并找到了新的制造合作伙伴。今年 3 月，意法半导体宣布与中国晶圆代工厂商英诺赛克达成 GaN 技术和制造协议。7 月，Navitas 宣布与台湾代工厂商力晶科技 (PSMC) 达成协议。然而，罗姆尚未公布新的 GaN 代工合作伙伴。

不过，这里还有一个悬而未决的问题。GaN芯片市场是一个快速增长的行业。那么，台积电为什么要退出GaN代工市场呢？

GaN生态系统

在回答这个问题之前，我们先来了解一下台积电和整个GaN市场。作为全球最大的晶圆代工厂，台积电在被称为晶圆厂的大型设施中为其他公司生产芯片。这家晶圆代工巨头最出名的就是为AMD、苹果、博通、英特尔、英伟达、高通等公司生产尖端芯片。

台积电还生产基于后沿工艺和特殊工艺的芯片，例如氮化镓 (GaN)。氮化镓是一种由镓和氮组成的 III/V 族化合物，是一种宽带隙半导体材料。与传统的硅基芯片相比，基于 GaN 材料的芯片可以在更高的电压、频率和温度下工作。

GaN 芯片生态系统由集成器件制造商 (IDM)、无晶圆厂设计公司和代工厂组成。IDM 是指设计、制造并在市场上销售基于 GaN 器件的公司。无晶圆厂设计并销售基于 GaN 的器件，但这些供应商不拥有晶圆厂。代工厂则为其他公司生产芯片。

那么，GaN器件市场本身可以分为两个子领域：电力电子和射频。在射频领域，GaN器件用于5G无线设备、国防电子和其他产品。

电力电子是一个广泛的领域，涉及系统中电力的控制和转换。基于GaN的功率芯片用于各种应用，例如汽车、快速充电器和电源。

GaN器件市场正在增长。然而，台积电却出人意料地宣布退出GaN代工领域。台积电相关人士表示：“经过全面评估，我们决定在未来两年内逐步退出氮化镓业务。这一决定基于市场动态，并符合我们的长期业务战略。我们正与客户密切合作，确保平稳过渡，并将继续致力于在此期间满足他们的需求。我们将继续专注于为合作伙伴和市场提供持续的价值。我们预计这一决定不会影响我们之前宣布的财务目标。”

然而，一段时间以来，有迹象表明台积电计划退出GaN市场。市场研究公司TechInsights的分析师Cédric Malaquin在一篇博客中表示：“早在4月份，TechInsights的行业分析师就已观察到客户撤出台积电GaN业务的早期迹象，尤其是意法半导体与Innoscience签订的GaN供应和开发协议。”

2020年，意法半导体与台积电结成GaN代工联盟。然而，2025年3月，意法半导体宣布与中国英诺赛科达成一项新的GaN技术开发和制造协议。英诺赛科自称是全球最大的专注于GaN的IDM公司。英诺赛科在中国的一座200毫米晶圆厂生产其GaN器件。

与此同时，多年来，台积电一直为纳微（Navitas）生产基于GaN的芯片。随后，在2025年7月，总部位于美国的纳微宣布与台湾力积电（PSMC）建立新的代工合作伙伴关系。根据该计划，力积电将在其位于台湾的200毫米晶圆厂生产纳微的GaN IC产品组合。

力晶半导体预计还将生产纳微（Navitas）的GaN产品组合，额定电压范围为100V至650V。100V系列预计将于2026年上半年在力晶半导体投产。650V器件将在未来12至24个月内从台积电转移到力晶半导体。

另一家公司罗姆 (Rohm) 宣布将于 2024 年与台积电 (TSMC) 建立 GaN 代工联盟。日本罗姆 (Rohm) 尚未指定新的代工合作伙伴。

台积电为何退出GaN业务？

不过，问题很明确：台积电为什么要退出GaN代工业务？在我看来，可能有以下五个原因：

1-GaN代工市场吸引力下降

多年来，台积电一直为多家代工客户生产基于GaN的器件。对于台积电而言，GaN业务规模虽不大，但它带来了稳定的销售收入和可观的利润。

台积电将继续为客户生产GaN器件直至2027年。但如果台积电决定继续留在GaN代工领域，该公司将需要投资该技术。“尽管台积电继续在其6英寸生产线上生产GaN器件，但整个行业正在迅速向8英寸晶圆过渡，这可能会削弱台积电GaN业务的战略价值，”TechInsights的Malaquin表示。

台积电有能力将GaN生产迁移到200毫米晶圆厂。但从某些方面来看，该公司投资200毫米GaN生产的财务状况并不合理。

如今，GaN代工市场已变得过于拥挤。很快，就会有太多GaN代工厂商争夺一个相对较小的市场。许多GaN代工厂很快就会展开价格竞争。利润率可能会大幅下降。

2-GaN 仍然是一个小市场

GaN器件市场正在增长。据Yol​​e集团预测，功率GaN器件市场规模预计将从2023年的2.6亿美元增长到2029年的20.1亿美元。此外，射频GaN器件市场规模预计将从2023年的11亿美元增长到2029年的20亿美元。

与台积电最大的几个市场相比，这些数字显得微不足道。例如，台积电最大的市场是高性能计算 (HPC)，其中涉及人工智能芯片领域。英伟达是台积电在该领域最大的代工客户。2025 年第一季度，仅 HPC 市场就贡献了台积电约 59% 的销售额（高达 150 亿美元）。

此外，2025年下半年，台积电将加速其新的2纳米工艺。该工艺需要巨额投资。

虽然台积电将继续服务于后缘和特殊市场，但该公司需要做出一些艰难的选择。它不可能服务于所有市场。专注于人工智能和2纳米技术等更大的市场也是明智之举。

3-GaN器件市场正在成熟

几年前，GaN 还是一项新兴技术。基于 GaN 的功率放大器主要用于军用雷达和手持通信设备。随着时间的推移，GaN 器件开始进军商业市场。

然而，近年来，有迹象表明 GaN 器件市场正在走向成熟。随着时间的推移，越来越多的公司进入了 GaN 芯片市场。此外，许多来自中国的新进入者也加入了 GaN 市场。然而，市场规模尚不足以支撑所有供应商。因此，GaN 器件市场开始整合。大型供应商正在吞并规模较小的供应商。

诚然，GaN器件领域仍然是一个潜力巨大的市场，充满机遇。但一场价格战即将来临。

除此之外，越来越多的代工厂商，尤其是来自中国的代工厂商，已经进入了GaN市场。GaN代工厂商数量过多。到一定时候，GaN代工厂商之间将只进行价格竞争，这反过来可能会导致该领域的洗牌。

从好的方面来看，GaN的市场前景远好于另一种宽带隙半导体材料碳化硅（SiC）。不久前，SiC功率器件的需求量巨大。这些器件广泛应用于电动汽车（EV）、电源、太阳能逆变器和其他产品。

但除中国和其他几个国家外，电动汽车销量一直令人失望。因此，对SiC器件的需求疲软。如今，SiC器件市场一片惨淡。

4-中国因素

如上所述，英诺赛克以及其他中国公司正在GaN器件市场展开竞争。此外，据TechInsights称，包括AMSfab、三安集成电路和华润微电子旗下的润芯微在内的多家中国晶圆代工厂正在加速其GaN业务发展。

最糟糕的情况是：中国可能会在价格上展开竞争，并颠覆整个 GaN 市场。

5-台积电可以将业务移交给VIS

台积电计划退出GaN业务。不过，未来台积电可以简单地将所有潜在的GaN代工业务转让给台湾代工厂商万兆国际半导体（VIS）。台积电是万兆国际的大股东，持有万兆国际27.55%的股份。

VIS 提供多种代工工艺，包括 200 毫米 GaN 技术。台积电可以将未来的 GaN 业务委托给 VIS。这使得台积电的 GaN 决策更加合理。

<https://marklapedus.substack.com/p/5-reasons-why-tsmc-is-exiting-the?r=3qbuhb&utm_campaign=post&utm_medium=web&triedRedirect=true>

## 14.5 台积电退出氮化镓代工业务 — IDM 是氮化镓的制胜法宝吗？

台积电已确认到 2027 年将完全退出 GaN 晶圆代工市场，这标志着该行业如何进行氮化镓生产的转折点。虽然传统代工厂退后了，但英飞凌和中国英诺赛科等参与者在 IDM 模型和深度垂直整合的支持下正在领先。

🔘 为什么代工模型在 GaN 中失去了吸引力？
根据 Innoscience 主席 Weiwei Luo 的说法，功率 GaN 器件并不适合传统的代工模式。这些器件需要设计、外延、工艺和应用之间的紧密耦合，而代工厂-客户模型很难支持这一点。相反，IDM 提供了满足市场需求所需的敏捷性和控制力。

🔘 工艺线索：GaN 从根本上不同
GaN 器件可能涉及 ~100-150 个工艺步骤，主要围绕 MOCVD 外延、隔离和 8 英寸晶圆上的器件制造。相比之下：
- 硅超结 MOSFET 需要 ~200-250 个步骤，在 ~0.18-0.35 μm 节点处采用复杂的沟槽和掺杂工艺。
- 高级逻辑 CMOS 在 5–28 nm 节点上运行超过 1,000 步。

GaN 的价值在于材料优势，而不是光刻缩放。这使得它更适合在更高电压和频率下实现功率效率，而不是密度或集成。

🔘 IDM 势头正在增强
Innoscience 已经交付了：
- 到 2024 年底达到 13,000 片/月，目标是到 2028 年达到 70,000 片/月。
- 全光谱 8 英寸 GaN-on-Si 产品线。
- 人工智能/数据中心氮化镓出货量同比增长 669.8%，电动汽车级同比增长 986.7%。
- 用于类人机器人的 100W GaN 驱动器的量产。

尽管 12 英寸 GaN 已在路线图上，但 MOCVD 工具尚未准备好用于生产级 12 英寸 GaN 外延，这使得 8 英寸成为当前行业的最佳点。

🔘 GaN 市场的下一步是什么？
- 到 2030 年，全球 GaN 功率器件市场预计将达到 $4.38B （TrendForce）。
- 电动汽车、AI 数据中心、机器人和工业电源推动的增长。
- 具有过程控制和垂直整合的 IDM 参与者可能会引领潮流。

代工模型针对体积和多功能性进行了优化。相比之下，GaN 需要垂直专业化和紧密的设计-制造耦合。

💡 台积电的退出可能标志着差异化制造战略的转折点——这种战略更注重深度而不是广度，更注重协作而不是商品化，更注重价值链所有权而不是交易可扩展性。

参考来源： https://lnkd.in/g5DzSKap ;https://lnkd.in/gXXrdsn8

让我们一起塑造未来：👉 https://lnkd.in/gJ3SSg8c

<https://www.linkedin.com/posts/jack-tsaur-58468a183_gan-powerelectronics-tsmc-activity-7349276403474780160-_XBl?utm_source=share&utm_medium=member_desktop&rcm=ACoAABGWyPMBLFNxf3scogFtv9nykpinaNDDgrc>
...
NTT基础研究实验室（BRL）衷心感谢您对我们研究活动的关注和支持。BRL
的使命是推动科学进步并为NTT的业务做出贡献。为了实现这些使命，我们在材料科学、物理科学和光学科学领域开展基础研究。
我们管理的根本是“开放”政策。例如，我们与日本、美国、欧洲和亚洲的许多大学和研究机构以及其他NTT实验室合作。我们还在厚木研发中心举办“科学广场”和量子物理与纳米科学国际会议，以传播我们的研究成果并听取您的意见。此外，我们每隔一年赞助面向全球年轻研究人员的“BRL学校”。在这所学校里，我们邀请世界各地的杰出研究人员担任讲师，为包括NTT研究人员在内的年轻研究人员提供向量子物理学领域的顶尖权威学习并交流想法的机会。
这些活动使我们能够践行“开放”政策，履行促进科学进步以及为NTT业务贡献的使命。衷心感谢您一直以来的支持。
...
# 27. 氮化镓在电动汽车发展中的作用：能源应用、技术和挑战

电动汽车 (EV) 直到最近才发展成为一项当代发明。许多国家都在加速发展电动汽车，以减少对石油的依赖以及对环境污染的贡献。在现实世界中，与任何其他传统汽车不同，纯电动汽车不会从排气管排放任何二氧化碳 (CO 2 )。这导致每年空气污染减少 50%-70% 的二氧化碳。交通电气化的实现导致车辆重量和尺寸的减小，因为可以消除对内燃机的需求。宽带隙材料，如碳化硅 (SiC) 和氮化镓 (GaN) 在电动汽车制造中具有优势。从 2000 年代后期开始，电动汽车行业已开始在其制造工艺中采用 GaN 器件。半导体材料 GaN 因其高开关频率、更高的温度极限和高电压击穿而成为电动汽车电力电子系统的材料。本综述旨在全面概述用于电动汽车应用的半导体 GaN 材料，这可为研究人员和科学家提供见解，以加速他们改进电动汽车的创新。本综述首先介绍电动汽车，然后介绍对电动汽车的预期需求。本文讨论了 GaN 器件在电动汽车中的应用，并与传统的 Si 和 SiC 器件（当前电动汽车的主要功率器件）进行了比较。本文还讨论了 GaN 器件的最新进展，这些器件不仅可用于全自动电动汽车的各种组件，如电池、储能系统、辅助动力装置和电机驱动器，还可用于不同的非汽车车辆，如电动飞机、电动船、电动铁路、电动潜艇和重型车辆。最后，本文讨论了 GaN 器件带来的挑战以及克服这些缺点的潜在解决方案。
...
## 31.2 华为长期使用氮化镓作为 5G 功率放大器，从而领先于爱立信和诺基亚。

<font color=red>Lum 表示，由于美国没有取得明显进展，5G 网络使用的氮化镓基射频功率放大器市场目前是恩智浦、住友和“华为在中国通过代工厂使用的任何公司”之间的三方竞争。</font>

华为拥有一项美国难以伤害的 5G 优势
一位知名分析师表示，随着中国采取措施切断对美国的镓供应，华为长期使用氮化镓作为 5G 功率放大器，从而领先于爱立信和诺基亚。

当美国试图通过更严厉的制裁和填补旧贸易规则的漏洞来阻止中国芯片制造商时，中国进行了反击。据报道，12 月 4 日，中国政府禁止向美国出口某些半导体的关键原材料。其中就包括一种叫做镓的物质。镓与氮结合会产生一种叫做氮化镓的化合物。如果没有它，当今 5G 网络中使用的无线电就不会这么好。

不幸的是，正如拜登政府在几年前发表的一份关于供应链风险的长篇报告中承认的那样，大多数镓都在中国。“用于生产晶圆的原材料——包括硅和镓——都集中在中国，”作者写道。他们后来强调了这一点，指出“中国是全球领先的镓供应国，而镓是氮化镓和砷化镓半导体的基本元素之一。”

除其他外，氮化镓作为 5G 产品中使用的射频 (RF) 功率放大器的原材料，与硅相比具有优势。专家表示，对氮化镓的投资在一定程度上解释了为什么华为（中国最大的 5G 设备制造商）能够生产出比中国境外的主要竞争对手更轻巧、更节能的 5G 无线电。

美国的制裁显然阻止了华为进入全球最先进的芯片代工厂台积电，并阻止这家中国公司获得 5 纳米甚至更小的芯片，用于智能手机和 5G 基站产品。但打击华为的功率放大器似乎要困难得多，并不是因为这种重要的原材料主要不在美国管辖范围内。

三体问题

EJL Wireless Research 创始人 Earl Lum 表示，氮化镓是通过一种称为金属有机化学气相沉积 (MOCVD) 的工艺制成的，而制造该工艺的工具在中国随处可见。他告诉 Light Reading：“用于制造氮化镓外延材料的 MOCVD 机器与用于制造蓝色和绿色 LED 的机器相同。”“中国有数千台这样的机器运来制造绿色 LED，可以改装成制造 RF。”

此外，在美国，几乎没有人成功开发出高性能的氮化镓基射频功率放大器。“除了 NXP，美国没有其他公司能够制造出放大器，”Lum 说。“Qorvo 尝试过，但没有成功。Skyworks 也从未成功过。Macom 和其他一些公司也尝试过。但实际上没有人成功。”

华为此前从日本住友电工采购氮化镓基射频功率放大器。但据报道，在 2019 年底，随着美国开始采取严厉措施，华为开始将其海思子公司设计的智能手机功率放大器的生产转移到一家名为厦门三安的中国晶圆厂，该晶圆厂如今在其网站上宣传其使用氮化镓及其在外延生长中的作用。Lum 表示，由于美国没有取得明显进展，5G 网络中使用的氮化镓基射频功率放大器市场现在是恩智浦、住友和“华为在中国通过代工厂使用的任何产品”三方竞争的局面。

与此同时，这位分析师认为，爱立信和诺基亚在将氮化镓引入 5G 产品方面继续落后于华为。他说，部分原因是等待恩智浦在亚利桑那州开设氮化镓工厂，最终在 2020 年底开设了工厂。“西方人之所以迟到，部分原因是恩智浦在亚利桑那州的砷化镓、氮化镓代工厂和工厂建设落后，”Lum 说。“所以每个人都不得不等待这件事真正发生，因为他们使用了很多恩智浦的芯片。”

更轻更好

专家表示，依赖一种较旧的硅基替代品，即横向扩散金属氧化物半导体 (LDMOS)，通常会导致功率放大器效率降低，5G 无线电更重。据电信公司消息人士称，尽管美国的制裁影响了华为其他业务，但该公司最先进的 5G 无线电单元的重量仍然低于爱立信和诺基亚销售的产品。

无线电设备的重量和能效是电信公司投资 5G 网络的关键因素。较重的设备通过对流或风扇冷却，自然会给天线杆带来更大的压力，因此可能需要加固来支撑它。安装也可能需要额外的工人，这进一步推高了成本。而无线电设备的能耗是网络运营商的一项重大运营支出。

因此，华为的竞争对手已将 LDMOS 转向氮化镓，用于设计用于 5G 更高频段的产品，这并不令人意外。当被问及三星的氮化镓投资时，这家韩国供应商的发言人通过电子邮件表示：“三星在其射频功率放大器中使用氮化镓，因为它被广泛认为是满足 5G 高频要求的最佳选择。”早在 2020 年，爱立信就强调了其在 5G 中利用氮化镓的努力。

如果中国对镓出口的禁令得到妥善执行，可能会对西方供应商的战略造成极大损害。至少，这会增加原材料成本。但对于美国当局来说，限制华为在这一领域的难度可能比限制芯片行业的其他领域更大。虽然美国可能已经能够切断中国与住友的联系，但除了阻止未来向华为销售美国制造的代工设备外，它几乎无法阻止为华为服务的任何中国代工厂。

今年年初，华为仍在宣称其在 5G 功率放大器方面处于领先地位。华为运营商网络首席营销官宋志强在今年的世界移动通信大会上表示：“对于这一组件，我们领先竞争对手一代，因此，根据第三方报告，我们的市场份额一直处于领先地位。”经过数年的制裁，这会让美国鹰派感到恼火。

<https://www.lightreading.com/5g/huawei-has-one-5g-power-that-is-hard-for-the-us-to-hurt>

## 31.3 EPC创始人：GaN临界点已到来
...
凭借近50年的功率半导体行业经验，我们可以确定，目前有<font color=red>4个关键因素</font>正在确保GaN达到临界点，并最终在超越硅MOSFET方面发挥至关重要的作用。除了成本、性能和可靠性之外，这4个因素还包括：
...
对于 GaN 技术而言，<font color=red>激光雷达</font>提供了第一个跨越临界点的应用场景。这一成功背后的简单原因是：GaN的开关速度比MOSFET快得多。Velodyne公司富有远见的创始人及现代激光雷达之父Dave Hall洞若观火，最早充分意识到GaN技术可使雷达比汽车传感器比看得更远、分辨率更高。为此，Hall在开发旋转激光雷达系统就率先使用了EPC的第一代GaN晶体管，这一举动也间接加速了自动驾驶汽车的诞生。
...
GaN达到临界点的第二个应用是<font color=red>卫星电源</font>。GaN不仅性能优于 MOSFET，而且几乎不会因为太空辐射影响而导致性能下降，帮助达到这一临界点的关键人物是VPT公司CEO兼创始人 Dan Sable。截至目前，GaN 晶体管在卫星电源领域仅部署4年，但已经蚕食了卫星MOSFET 器件30%的市场份额，并且随着传统设计变得过时或不经济，GaN晶体管有望吃掉最后的 70%市场蛋糕。

GaN 的第三个转捩点是<font color=red>快速充电器</font>。这方面的佼佼者是纳微半导体的CEO兼联合创始人 Gene Sheridan。如今，几乎所有的快速充电器都使用GaN，因为它能够提供高功率，为耗电的手机、平板电脑和笔记本电脑充电，所需时间仅为硅基充电器所需时间的一小部分。

继前3大市场成功规模化商用后，GaN现在再一次站在了最重要的转捩点之上：<font color=red>人工智能</font>。
...
- 知名度：就像MOSFET当时的情况一样，每一项新的终端应用发展都在向其他终端用户群体宣传GaN的独特价值，并加速它在其他市场中的必然应用。
- 天时：随着GaN带来的每一次新的积极体验和商业成功，全球范围内的采用和实施正在不断增加，这创造了越来越多的设计窗口机会。
- 地利：出现了新的GaN拥护者和新的资金来源。
- 人和：在过去几年中，数千名经过培训的设计和制造工程师已经提升了学习曲线，现在知道如何提取GaN的额外效率。
...
<https://www.eet-china.com/mp/a377865.html>

## 31.4 到2030年取代手机中的GaAs

在过去的30年里，GaAs微电子技术的发展机遇日益缩减。在20世纪的最后十年，数字GaAs应用于光网络基础设施，驱动着一系列元件，包括激光器、跨阻放大器和多路复用器。在互联网泡沫破灭后，硅和SiGe元件占据了主导地位，射频领域占据了GaAs晶体管的全部销售额。虽然国防和网络基础设施也带来了一些收入，但手机占据了最大的份额。最初，GaAs pHEMT提供开关功能，后来被绝缘体上硅技术取代，GaAs的主要作用是功率放大。但现在，这一地位正受到威胁，美国公司Finwave预测，到2020年，GaN将在手机中承担这一任务，同时，GaN作为开关和功率放大器在基础设施、航空航天和国防应用中的应用也将带来额外的销售额。

Finwave 首席执行官 Pierre-Yves Lesaicherre 表示，GaN 之所以能在手机功率放大器 (PA) 领域胜过 GaAs，是因为现有技术在 6 GHz 以上频率下已失去发展动力。Lesaicherre 指出：“GaN 的功率效率实在太低了。”他指出，Finwave 的增强型 MISFET 技术采用 5 V 电源供电，可在 6 GHz 至 40 GHz 的频率范围内提供高功率附加效率。这些优势，加上其高功率密度能力，确保了 GaN MISFET 成为 WiFi 7、用于 5G 通信的 FR3 频段以及未来将用于 6G 通信的频段放大器的理想选择。

取代 GaAs PA 是 Finwave 的长期目标，自 2023 年夏天 Lesaicherre 上任以来，该公司在许多方面都取得了进展。

Finwave 是麻省理工学院的衍生公司，但其根基仍然扎根于当地。其 23 人团队中约有一半位于波士顿附近的沃尔瑟姆，致力于研究与公司专有的硅基氮化镓 (GaN-on-silicon) 技术相关的工艺和器件架构。

其余负责产品设计、产品工程测试和质量以及供应链的团队位于加州圣地亚哥。“我们已经搬到了索伦托谷一个更大的办公室，就在pSemi和高通旁边，”Lesaicherre说道。

雇用几名额外的射频设计师、任命一名营销副总裁和一名首席财务官以及建立设备生产合作伙伴也为进一步的成功奠定了基础。

Lesaicherre 表示：“2024 年 8 月，我们与格芯签署了一项技术许可和转让协议，将我们的低压 E-Mode MISHEMT RF 硅基氮化镓技术转让给手机应用。这项技术独一无二，目前正在转移到佛蒙特州伯灵顿的一家 8 英寸晶圆厂。”

过去几个月巩固的第二个重要合作伙伴关系是与台湾一家领先的代工厂建立的，该代工厂已开始生产 Finwave 的射频开关和高功率放大器，用于通信和基础设施应用。

为了生产封装器件，Finwave 在马来西亚还有另一个合作伙伴 Unisem。Lesaicherre 称，这家后端服务提供商是射频半导体领域领先的测试和组装公司。

最近，Finwave通过引入产品生命周期管理系统和质量管理系统，完善了其供应链。未来几年，Finwave将与一家领先的射频分销商签署分销协议，以支持其销量的增长。该协议的具体细节将在未来几周内公布。

Finwave 的产品路线图
Finwave 今年上半年的目标包括在 2025 年第一季度完成其首批射频开关的工艺和产品认证，随后在随后的一个季度提高前三个射频开关的销量。

Lesaicherre 透露：“这些产品包括 10 瓦、20 瓦和 40 瓦的射频开关，工作频率范围从几兆赫到 13 千兆赫。”他认为这些设备提供了独特且引人注目的优势组合。它们能够处理高功率和高频率，并且具有非常快的开关和稳定时间——仅为数百纳秒。

Lesaicherre 表示，基于绝缘体上硅 (SOI) 技术的开关的弱点之一是其功率处理能力有限，因为它们难以处理 10 瓦以上的信号。

Lesaicherre 表示：“我们认为我们的产品更像是 RF SOI 开关的延伸，而非直接竞争对手。现在，我们与碳化硅上氮化镓 (GaN-on-SiC) 开关竞争，但生产成本要低得多，这为我们带来了巨大的价格优势。”

Finwave 的交换机产品组合今年将进一步扩展，推出更多产品。随着第二代技术的研发，其性能提升也正在酝酿中。

这家无晶圆厂公司生产的开​​关可广泛应用于国防和基础设施领域。其中蕴藏着诸多机遇，包括雷达、军用无线电系统和基站。

除了扩大其交换机产品组合外，Finwave 还专注于用于通信基础设施的高功率放大器的商业化，其工作电压通常在 15 伏至 28 伏之间。

Lesaicherre 声称：“这里的主要竞争对手也是碳化硅基氮化镓 (GaN-on-SiC)。同样，我们拥有巨大的成本优势，并且有能力扩展到 8 英寸晶圆，未来甚至可能扩展到 12 英寸晶圆。”

Finwave 的另一个激动人心的机会是，它有可能将功率放大器 (PA)、低噪声放大器和开关集成在单个硅基氮化镓 (GaN-on-silicon) 芯片上。Lesaicherre 表示，与当今集成了多个芯片、采用不同材料系统制造的射频前端相比，这种技术有望带来显著的成本和集成优势。“我们认为，这是电信基础设施的关键差异化因素。”

对于 Finwave 发现的第三个机会——取代手机中的 GaAs PA——硅基 GaN 提供的更高性能以及生产包含 PA、低噪声放大器和开关的单芯片的可能性可以推动硅基 GaN 技术的发展。

焦点转移
Finwave 从麻省理工学院 (MIT) 实验室独立出来时，最初名为剑桥电子 (Cambridge Electronics)，其 finFET 技术备受瞩目。虽然 Finwave 的新兴开关和功率放大器产品均基于平面架构，并未采用该技术，但 Finwave 并未放弃这种新颖的晶体管设计方法。“我们还证明了，利用 3D finFET 架构，我们可以提高用于基础设施的 D 型功率放大器的线性度，但我们尚未量产这些产品，”Lesaicherre 透露。

过去几年中，关注点的另一个转变是从追求电力电子领域的成功转向专注于射频领域的机会。

Lesaicherre 强调：“我们在低压和中压 GaN 技术方面取得了一些令人瞩目的进展，因此我们相信我们的技术能够满足这个市场的需求，但我们目前的重点是射频应用。我们正致力于开发全系列的射频开关和功率放大器。”
...
## 35.1 onsemi 是否会稳步重返 GaN 市场？

onsemi 最近通过一项收购行动引起了人们的关注，一些人认为这是该公司重返氮化镓 (GaN) 市场的潜在机会。GaN 半导体因其卓越的效率和性能而备受瞩目，尤其是在电动汽车、可再生能源系统和工业自动化等应用中。随着行业继续转向高性能、节能的解决方案，对 GaN 技术的需求只会增长，预计到 2020 年代后期，市场复合年增长率将超过 25%。

对于安森美来说，这一战略举措来得正是时候，因为安森美在比利时的分拆出来的 GaN 公司 BelGaN 于 2024 年中期破产。从那时起，安森美一直对其在 GaN 制造市场的动向保持沉默，只暗示通过收购回归。在此背景下，安森美斥资 2000 万美元收购前 NexGen Power Systems 位于纽约德威特的制造工厂，可能是该公司重新进入 GaN 市场的信号。

本文探讨了安森美的投资是谨慎地重新进入 GaN 市场，还是为了配合其总体增长计划而采取的慎重措施。通过在行业趋势、安森美现有的碳化硅 (SiC) 产品组合及其更广泛的战略背景下研究此次收购，我们旨在揭示此举对公司在 2025 年及以后实现增长的影响。

收购

2024年12 月 13 日，安森美斥资 2000 万美元收购了位于纽约德威特的制造工厂，这一举动在很大程度上没有引起很多人的注意。然而，这次收购可能是扩大其在 GaN 半导体市场能力的重要一步。

该设施最初由纽约州斥资约 1 亿美元建造，但自从 GaN 初创公司 NexGen Power Systems 于 2023 年因财务困难停止运营以来，该设施一直处于闲置状态。尽管获得了超过 1300 万美元的州政府补助，并在纽约纳税人建造的设施中运营，但该公司仍无法维持业务，并在 2023 年圣诞节前不久解雇了员工。

2023 年早些时候，NexGen 宣布与通用汽车合作，并获得美国能源部的支持，利用其技术开发电力驱动系统。然而，该公司难以获得持续的风险投资支持或新资本，最终导致其关闭并申请破产。

考虑到该工厂之前专注于GaN领域，此次收购为已在全球运营20个制造基地的安森美半导体提供了一个现成的制造基地，而所需的成本和时间仅为建设新工厂的一小部分。

onsemi 已承诺，该工厂将雇用 80 至 100 名工人，专注于生产基于 GaN 的半导体。GaN 技术在以下应用中特别有价值：
...
该工厂使 onsemi 有能力满足日益增长的 GaN 半导体需求，GaN 半导体对于需要节能、高性能组件的行业至关重要。

战略举措
收购一家利用率不足的工厂可让安森美半导体快速进入新的市场或扩大其在 GaN 市场的现有地位，而无需延长建造新工厂所需的时间和成本。此次收购补充了安森美半导体在碳化硅 (SiC) 领域的既有能力，有望使该公司服务于更广泛的电力电子市场。

虽然安森美半导体尚未明确说明选择该工厂的原因，但此举符合行业趋势，即重新利用闲置的晶圆厂来满足日益增长的半导体需求。该公司的行动表明，该公司正在精心规划如何利用现有资源和基础设施，这支持了其更广泛的目标，即有效扩大生产规模，同时实现半导体产品组合的多元化。

通过投入运营 DeWitt 工厂，安森美半导体将为全球 GaN 供应做出贡献，而此时可再生能源、汽车和工业应用等多个领域的需求正在加速增长。

面向未来，实现多元化

onsemi 向碳化硅 (SiC) 和氮化镓 (GaN) 技术多元化发展，体现了公司在一系列电力电子市场中实现持续增长的战略定位。随着对高效电源解决方案的需求不断增长，满足不同性能和应用需求的能力变得越来越重要。

onsemi 已成为 SiC 市场的主要参与者之一。截至 2024 年，onsemi 继续加强其在 SiC 市场的地位。2023 年，该公司的市场份额达到 23.6%，仅次于占有 32.6% 份额的 STMicroelectronics，位居全球第二，并计划在 2030 年实现 35-40% 的 SiC 市场份额。

该公司在 SiC 生产方面投入了大量资金，以满足汽车和工业领域的需求，这些领域继续推动对更高效、更可靠的电源解决方案的需求。这种专注已获得回报，安森美半导体报告其 SiC 业务增长强劲，为其整体收入做出了重大贡献。

然而，尽管 SiC 对于高功率应用至关重要，但 GaN 适用于中功率/电压应用，在这些应用中它越来越受欢迎。通过扩展到 GaN，安森美半导体将使其产品组合多样化，以服务更广泛的行业并减少对单一技术的依赖。这种多元化战略可以帮助公司抵御市场波动，因为它将不太容易受到任何一个行业内需求变化的影响。在 GaN 越来越受欢迎和 SiC 盛行的电动汽车市场动荡的背景下，这一点尤其重要。

尽管 SiC 和 GaN 的应用领域不同，但由于其效率和性能均优于传统硅元件，它们都被视为下一代功率半导体材料。它们的互补性使 onsemi 能够：

通过提供满足更广泛电力需求的解决方案来扩大客户群

利用宽带隙材料方面的专业知识优化研发工作
通过减少对任何单一技术或行业领域的依赖来增强市场弹性
onsemi 高度重视 GaN 生产，并持续投资 SiC，这使其处于有利地位，可以利用电动汽车、可再生能源和数据中心等高增长领域。通过协调其 SiC 和 GaN 战略，该公司正在应对未来的需求趋势，同时减少市场波动带来的影响。

进入 2025 年，随着各行各业寻求更高效、可持续的电力技术，安森美提供扩展的 SiC 和 GaN 解决方案的能力可能将成为关键的差异化因素。

与更广泛的战略保持一致
SiC 一直是安森美半导体的重要收入来源，2023 年该公司的市场份额为 23.6%，成为全球第二大 SiC 供应商，仅次于意法半导体，市场份额为 32.6%。安森美半导体优先考虑将 SiC 用于高功率和高压应用。

2024 年 12 月，安森美半导体以 1.15 亿美元收购 Qorvo 的 SiC 业务，进一步扩大了其 SiC 产品组合。此次收购增强了其扩大生产规模和满足日益增长的客户需求的能力，尤其是来自汽车行业的需求，该行业正在转向 SiC 以提高电动汽车的效率和续航里程。

该公司致力于扩大 SiC 产量，这体现在其对垂直整合的持续投资，确保对整个供应链（从原材料到成品）的控制。这种方法有助于 onsemi 降低供应链风险并保持具有竞争力的成本结构。

虽然安森美对 SiC 的关注度显而易见，但最近收购纽约德威特制造工厂表明其对 GaN 技术重新产生了兴趣。GaN 更适合中等功率、中等电压的应用，而 SiC 在这些应用中不太合适。

重新进入 GaN 市场的决定正值行业优先考虑效率和可持续性，而 GaN 基半导体的需求正在加速增长。此次收购使 onsemi 能够扩大 GaN 产量，而无需从头开始建设新设施所需的大量资本支出，从而提供更快、更具成本效益的上市途径。

除此之外，SiC 和 GaN 技术的组合为安森美提供了平衡的产品组合，以满足广泛的客户需求。通过跨这两种宽带隙半导体技术的多元化，安森美减少了对任何单一市场或技术的依赖，从而增强了其对需求波动的抵御能力。这种双重战略还使公司能够抓住成熟市场和新兴市场的机会。

展望 2025 年，SiC 和 GaN 市场预计将继续快速增长：

预计到 2030 年，全球 SiC 市场规模将达到 100 亿美元，主要受电动汽车的普及和工业应用的推动。
预计到 2029 年 GaN 半导体器件市场将增长至约 42.5 亿美元，复合年增长率 (CAGR) 为 22.3%。
onsemi 能够提供 SiC 和 GaN 解决方案，这将使其能够满足这两种日益增长的需求。通过确保对供应链的控制、扩大生产能力并满足多样化的市场需求，随着行业向更节能的电源解决方案过渡，该公司已准备好实现持续增长。

onsemi 制定了明确的战略，即利用其在 SiC 领域的领导地位，同时重新确立其在 GaN 市场的地位，这种方法似乎可以确保长期成功。

这一切意味着什么

onsemi 收购 DeWitt 制造工厂无疑是一个有趣的时刻，可能会对其进军 GaN 市场的方式产生重大影响。继 BelGaN 破产后撤退之后，这一战略举措似乎表明了一次更加慎重、有计划的回归，而不是试探性地重新进入，但并没有全力以赴。通过以建造新工厂成本的一小部分获得一座随时可用的 GaN 工厂，onsemi 旨在利用可再生能源、电动汽车和工业自动化等关键领域对 GaN 半导体日益增长的需求。

此次收购符合安森美更广泛的多元化战略，旨在平衡其强大的碳化硅 (SiC) 产品组合和中等功率 GaN 解决方案。通过提供 SiC 和 GaN 技术，安森美将满足下一代电源应用中更广泛的客户需求，从而降低依赖单一技术带来的市场风险。

DeWitt 工厂使安森美半导体能够迅速扩大 GaN 产量，缩短上市时间并增强竞争地位。随着行业越来越重视节能、高性能解决方案，安森美半导体对 SiC 和 GaN 的双重关注为持续增长提供了坚实的基础。
...
氮化镓 （GaN） 已成为一种革命性的半导体材料，有望改变电力电子和射频应用。与传统的硅基器件相比，GaN 器件具有卓越的性能，可实现更高的效率、更小的外形尺寸和更高的可靠性。

GaN 半导体器件的主要优势：

更高的功率密度：GaN 器件可以在更小的占用空间内处理更多的功率，从而实现紧凑和轻便的设计。

提高效率：更低的导通电阻和更高的开关频率可显著降低功率损耗并提高效率，从而节省能源并减少热量产生。

更快的开关速度：GaN 卓越的电子迁移率可实现更快的开关速度，从而提高需要快速响应时间的应用的性能。

增强的可靠性：GaN 器件具有更高的可靠性和更长的使用寿命，因为它们具有坚固的特性和在更高温度下运行的能力。

GaN 半导体器件的应用：

电力电子：

电源：基于 GaN 的电源为各种应用提供更高的效率、更小的尺寸和更轻的重量，包括消费电子、数据中心和工业设备。

电机驱动器：GaN 晶体管为电动汽车、机器人和工业自动化等应用提供更高效、更紧凑的电机驱动器。

可再生能源：氮化镓逆变器提高了太阳能和风能发电系统的效率。

射频应用：

5G 及未来：GaN 功率放大器对于 5G 基站和未来的无线通信技术至关重要，可在更高频率下实现更高的功率和效率。

卫星通信：基于 GaN 的放大器因其高功率和高效率而用于卫星通信系统。

雷达系统：GaN 的高频功能使其成为国防、航空航天和天气预报领域雷达应用的理想选择。

其他应用：

LED 照明：GaN 用于高亮度 LED，因为它的效率和产生多种颜色的能力。

LiDAR 系统：GaN 激光器用于自动驾驶汽车和其他需要精确距离测量的应用的 LiDAR 系统。

音频放大器：GaN 晶体管使高保真音频放大器具有更高的效率和线性度。

![](/picture/GaN%20Semiconductor%20Devices.jpg)
...
**GaN 公司将在 2024 年第四季度通过专利申请激增和最近的收购来整合其专利组合**

2025 年 2 月 19 日 │ 氮化镓 (GaN) 技术这一充满活力的领域继续改变半导体行业，专利活动取得了显著进展。GaN 的独特性能使其成为高性能功率和 RF 应用的关键材料。最近的数据显示，知识产权 (IP) 活动取得了重大进展，这些活动为该领域的研发 (R&D) 工作提供了支持。本文全面概述了 GaN 技术的最新趋势和突破性发明，重点关注专利活动和 IP 策略。在 KnowMade，我们通过GaN 专利监测器密切关注这一新兴领域。

GaN 公司将在 2024 年第四季度通过专利申请激增和最近的收购来整合其专利组合
法国索菲亚安提波利斯– 2025 年 2 月 19 日 │ 氮化镓 (GaN) 技术这一充满活力的领域继续改变半导体行业，专利活动取得了显著进展。GaN 的独特性能使其成为高性能功率和 RF 应用的关键材料。最近的数据显示，知识产权 (IP) 活动取得了重大进展，这些活动为该领域的研发 (R&D) 工作提供了支持。本文全面概述了 GaN 技术的最新趋势和突破性发明，重点关注专利活动和 IP 策略。在 KnowMade，我们通过GaN 专利监测器密切关注这一新兴领域。

GaN专利监测第4季度24期封面图片。

要点概述
GaN 技术最近的专利活动凸显了其在半导体创新中的关键作用。在过去一段时间内，已有 540 多个新的 GaN 专利系列发布，展现了充满活力的发明贡献。此外，已有 300 多个专利系列获得授权，标志着在确保 GaN 创新特定知识产权方面取得了进展。同时，在 2024 年最后一个季度，约有 130 项与 GaN 相关的专利被放弃或到期，其中包括Macom和Wolfspeed等 RF GaN 主要 IP 参与者的基本专利。

7 项专利转让说明了 GaN 领域的所有权动态，表明涉及 GaN 技术的战略调整。在收购功率 GaN 行业早期垂直 GaN 器件供应商的几项举措之后，Nexgen Power Systems的多项专利于去年年初重新分配给了onsemi ，而多项专利权于 2024 年晚些时候从Odyssey Semi转移到了Power integrations。今年以 GaN 电子专利领域历史悠久的 IP 参与者富士通与大多数现有 GaN 功率器件市场参与者的关键制造合作伙伴台积电之间的另一项交易收官。该交易从而加强了台积电在 RF 和功率 GaN 技术领域的 IP 地位。

值得注意的是，出现了 10 项知识产权合作，突显了 GaN 研发方面的合作努力。本季度，知识产权合作由领先的研究组织和政府机构推动，例如美国的麻省理工学院和美国海军。法律格局反映出美国有一起知识产权诉讼案件结案，而欧洲领域没有新的专利异议。GaN 行业中出现了 20 多家新公司，这凸显了人们日益增长的兴趣，并对五家领先的 GaN 公司进行了全面的知识产权分析：Innoscience、Infineon、ROHM、TSMC和ST。

值得注意的新发明
在晶圆和外延晶圆领域，博世凭借多项著名发明脱颖而出，推动了厚 GaN 外延层生长的衬底技术，例如将非晶层应用于硅等传统衬底，或使用包含不同于多晶 AlN 或多晶 SiC 的多晶基底的工程衬底，这与信越、Soitec和Qromis 等公司不同。

在器件领域，EPC的创新型 GaN HEMT 设计采用多层和多厚度屏障。此设计从栅极到漏极逐渐增加二维电子气 (2DEG) 密度。通过在不同厚度的屏障层上形成栅极，可以形成单片 GaN 功率 IC，其中 GaN 晶体管具有不同的阈值电压，例如包括 d 模式和 e 模式器件。

在封装和模块领域， Denso、Mirise Technologies和丰田汽车之间的合作旨在通过改善安装半导体封装的接线板的散热来解决基于 GaN 的功率设备中的关键热管理挑战。总体而言，本季度的亮点是Macom、Qorvo和住友电工等几家领先的 RF GaN 公司在 RF GaN 封装和模块方面的专利活动。

电路与应用部门证实了其活力，2024 年第四季度期间，几家关键的功率 GaN 市场参与者积极在该领域申请专利。其中包括Navitas Semiconductor，该公司披露了用于功率转换器电路的 GaN 功率级栅极过驱动的新电路和方法。

不断发展的营销策略：IP 监控的意义何在
随着 GaN 技术日益受到重视，各公司正在调整其营销策略，以突出该领域的创新和合作举措。利用 GaN 的独特优势，各公司旨在将自己定位在半导体进步的前沿。战略合作伙伴关系和 GaN 专利组合的扩展提供了竞争优势，这可能会在未来几年进一步促进知识产权合作和转让。各公司还在进行市场分析，以找出 GaN 细分领域的新兴参与者和机会。此外，在半导体市场的快速发展中，关于新 GaN 发明的技术优势和应用的透明沟通可以增强信任并提升品牌声誉。通过与这些战略保持一致，各公司寻求增强其在 GaN 技术领域的存在感，在快速变化的环境中利用其变革潜力。
...
# 40. 为 AI 数据中心提供动力：瑞萨电子与 GaN 时代 EETimes 播客

随着人工智能重塑数据中心，对更高效率、更高密度和更高可靠性的电力输送的需求正在推动半导体创新。瑞萨电子正利用其专业知识并扩展GaN产品组合，以适应这些变化。在本期播客中，瑞萨电子电源系统营销和架构高级总监Pietro Scalia将探讨向AI优化基础设施的转变、GaN在数据中心和高可靠性环境中的关键作用，以及在汽车、工业和消费市场更广泛应用的要求。我们还将探讨重要的架构决策和可靠性。

[完整文字记录如下]

我：嗨，Pietro。谢谢你来。你好吗？

附言：好的，Maurizio。非常感谢您今天参加我们的播客。

我：当然了。非常感谢您来到 PowerUP。Pietro，您在哪里？


附言：我今天在慕尼黑，这是我的主要工作地点。虽然我领导着一支全球团队，但另一方面，我已经在德国生活了15年多。

我：好的。今天的主题是数据中心、AI数据中心以及宽带隙技术，特别是氮化镓。我准备了几个问题与大家分享。我们先从第一个问题开始。瑞萨电子在数据中心领域取得了重大进展，尤其是在高密度电力输送方面。请您详细介绍一下瑞萨电子的情况。公司如何定位自身，以应对设计转型和架构转型，从而更好地服务于AI优化的基础设施？

PS：好的，谢谢。首先，谈论基础设施这个话题非常令人兴奋。当然，这是目前市场上最好的领域，我们非常自豪能够扮演重要角色。瑞萨电子凭借其庞大的产品组合，在数据中心基础设施领域占据着重要的市场份额和领先地位。这是一个成熟的电源解决方案生态系统，涵盖从数字市场到功率级，当然还有IBC解决方案，其密度高达几千瓦的负载点，以及所有相关的附加产品，例如[所有掉期结束]保护。这给我们带来了可观的收入，而且，尤其是它的增长速度甚至超过了市场的复合年增长率，所以我们非常高兴。说到正在发生的事情，对，这种架构的转变是由于功率水平的提高，配电总线的功率水平根据不同的原始设备制造商 (OEM) 的不同将达到正负 400 或 800，可以说这种转变实际上将扩展我们的 SEM，特别是针对高压 650 伏 GaN 端，这将发挥重要作用，而且在 100 伏时，在这些开关的生态系统中，MOSFET 和最终 GaN 端将得到普及。所以，这不仅仅是一个开关，也是驱动器。我们需要在这些新拓扑中实现控制器和保护设备。

我：谢谢，Pietro。确实，让我们来谈谈GaN。AI工作负载需要更高的功率密度、效率和功率密度，而效率是主要议题，但我想不仅仅是如此。那么您认为GaN如何在功率密度和效率方面（而非仅限于此）帮助应对这些挑战呢？您可以就[电机]数据中心架构中的这些挑战，与我们分享更多。

PS：是的。我认为GaN技术确实是一个推动因素。它提供了在整个开关频率下工作的可能性，从而提高了新型接收器所需的功率密度。目前，计算接收器的数量至少从72个开始，但预计市场领导者推出的新产品数量将上升到500个，比如GPU接收器，其功率高达600千瓦，甚至高达1兆瓦/接收器，以及交流到直流的侧接收器。当然，从这个意义上讲，它可以缩小空间，在相同空间内提高功率，大约相当于每立方英寸2000到3000瓦。所以，基本上，如果要实现高密度，GaN技术可以实现这一点。当然，这并非易事，因为它具有开关能力，没有分集编码损耗，而且与其他技术相比，它的开关损耗更低，无论是在开关拓扑结构中，还是在硬开关中。我认为还有另一个架构元素，那就是双向开关。该器件可以实现拓扑结构的某种转变。这绝对是一个重要的元素，因为在交流/直流转换方面，这将带来巨大的改变，因为你可以轻松实现两种多层拓扑结构，或者说，简化拓扑结构以降低损耗。我认为这对于取代其他技术，在更小的空间内以更低的速度实现相同的效率至关重要。

我：那么，让我们尝试以GaN为重点，瑞萨电子收购了Transphorm。通过收购Transphorm业务，我们的目标是加速GaN市场的发展，加速向8英寸晶圆的迁移。您能告诉我们，在这种情况下，这意味着什么吗？您认为哪些关键转折点将决定GaN的可扩展性和大众市场部署的准备程度？

PS：当然。收购Transphorm是一次明智的选择，现在几乎完成了全方位的整合。显然，我们收购了一家拥有良好技术的公司，它现在不仅在规模上，而且在制造方面也充分利用了瑞萨的规模优势，因为我们显然正在打造多区域业务，这也符合在三大洲顺利运营的需要，比如说在两大洲开展业务。我认为，就制造而言，根据不同的市场，情况会有所不同。今天我们看到，推动650芯片发展的市场主要是物联网和消费电子，比如充电器，对吧？但现在我们看到了基础设施领域的巨大发展势头，因此电源肯定需要这项技术。但它目前还没有实现规模化。因此，我们获得了这种势头，产量也会随之增加，因此8英寸晶圆就成为支持这种产量水平的必需品。我认为还有一个因素，当然是成本，对吧？从长远来看，GaN有潜力成为硅的竞争对手。因为理论上，同样的面积可以承受更大的功率。从这个意义上讲，如果拿苹果和苹果进行比较，拥有相同的晶圆是基础，最终不仅能与其他宽带隙材料竞争，也能与硅进行交叉竞争。因此，12英寸肯定会成为一个落地点。目前尚不清楚具体时间，但我认为这只是几年的问题，因为到那时，我认为以硅作为衬底，我们都能做到这一点。这是一个投资规模的问题。我认为实施这种制造方式需要资本支出。

我：所以，谈到GaN，在模式、模式和架构方面也存在着激烈的争论。从可靠性系统集成的角度来看，您对这种选择和设计选择持什么立场？对于数据中心来说，最重要的是高可靠性和应用，以及在成本结构方面？那么，这些要素和因素在Cascode模式和其他不同集成模式的选择中起着什么作用？您提到了650伏，这与硅的竞争，可能会改进GaN技术。我们也可以谈谈与碳化硅的竞争。

PS：是的。我认为这可以说是价值百万美元的问题之一，因为我认为，当你具体谈论一项新技术时，肯定会有各种不同的方案，各有优缺点。所以没有一种万能的解决方案。我认为我们的观点是高功率、高电压下的情况。假设[短]元件的导通电阻为650Ω，最终达到更高水平时会更高。我认为耗尽型由于多种原因具有更优异的品质因数。首先，我认为它是一种完全隔离的栅极，因此就器件的可靠性和稳健性而言，这是一个很大的附加值。其次，它的温度依赖性更低，对吧？通常情况下，耗尽型大约是[导通电阻]随温度升高而增加的一半。然后，实际上，增强效应不仅体现在参数的递增上，特别是动态导通电阻（RDS(on)）。我认为在增强型模式下，导通电阻会显著增加。我认为这是另一个关键方面。另外，我们需要考虑增强型方案中的反向传导，这种方案在高达 8 至 8 伏的高压下很容易发生，而在 Cascode 方法中，我们基本上能够像标准二极管一样提供 1 伏的电压。所有这些因素都会影响到更低功率，因为​​低电压的影响较小。因此，[emode] 当然很有吸引力，因为它的复杂性较低，当然，因为我们在 Cascode 方案中采用了芯片级芯片 (Chip-on-Chip) 解决方案。因此，我们也看到了增强型方案的价值，基本上我们采用了两种技术来解决整个功率和电压范围的问题。

我：很好。那么，现在谈谈成本、架构、制造和可靠性。随着GaN技术的发展，进军高可靠性市场，目前必须满足哪些行业标准或认证障碍？作为瑞萨电子，你们如何为定义长期可靠性数据做出贡献？因为这对在不同项目中转向GaN器件的电源工程师来说非常重要。

PS：当然。瑞萨电子是 GEDEC 的成员，我们遵循 GEDEC 已定义的 47 项资格要求。具体来说，HDIB、HDGP 和 [H-TOL] 测试，这基本上是一种升压硬开关测试，标准是 100 小时，3 个批次，77 个零件。我们对碳化硅的测试很熟悉，对吧？我认为这基本上是目前的测试标准。但我认为，另一方面，我们也超越了这些测试，因为我们认为我们应该测试其耐用性，尤其是与其他技术相比。例如，我们在 175 小时内进行 [H-TOL] 测试，而标准是 150 小时，我们将其延长至 3,000 小时。对于HTGB，我们采用负电压，即负35%，而标准电压为正20%。我认为HTRB对于估算我们之前讨论过的动态电阻变化非常重要，因为我们有时看到其他技术甚至会超过这个数字的三到四倍，对吧。这是公开信息，您可以在媒体上看到。我认为我们需要保证我们的技术非常稳定，以满足客户的需求。我认为开关的[短路扭转]随时间的变化是另一个重要参数，我认为目前尚未完全涵盖。至少对于电机驱动而言，我们认为这是一个关键规格。我认为，我们从碳化硅[L8H]中重新学习的经验说来话长。我认为存在不同的方法。我们有一些方法可以通过该技术的IP来本质上提高[短路扭转]随时间的变化。我们已经发布了一些相关文献。当然，另一种方法是将特定的驱动器与开关集成在一起。我认为，在建立这项技术方面，还有很多工作要做。但我认为我们已经走在了前列，所有必要的测试都已标准化。

我：谢谢，Pietro。说到可靠性，我想问一下封装方面的问题。封装是第一个容易失效的。如果我们谈论可靠性，那么我们谈论的是应用，在这种情况下也包括热性能。温度是一个重要因素。那么，在封装方面，哪些创新可以提高GaN在高功率应用中的可靠性？我们是否需要不同的改进和封装方面的进步来充分发挥GaN和晶体管的高速开关能力，因为这是GaN的主要元素？

PS：当然。我认为你触及了一个非常关键的点。封装在提高开关频率的过程中至关重要，同时，我认为，封装还能以适当的方式实现散热，从而降低高开关频率下的寄生效应。所以，我认为如今封装已经发展，但可能跟不上技术本身的发展速度。目前我们提供的标准封装，比如QFN、8x8（TOT），现在非常流行。但它们仍然是分立的，对吧？如今，将多个芯片集成到一个封装中的趋势更加明显，最终还会考虑驱动器，从而创建与GaN的合理对接。我认为，无论如何，这种封装都需要符合标准化的关键规范，以便能够支持多源供应。因此，这是一项需要采用的新技术，而且通常需要单一来源。显然，为了确保供应安全，这必然再次采用多源方案。从这个意义上讲，我们所做的不仅实现了源极向下（这是技术上的自然规律），还实现了某种程度的漏极向下。这样，我们基本上实现了 MOSFET 解决方案的引脚对引脚连接，因此根据 PCB 的性能，您基本上可以看到硅或 GaN 的使用量减少。因此，这再次表明我们致力于在封装解决方案上保持开放态度。我认为，特别是在 GaN 的对接方面，由于它非常新，因此在市场上仍有待巩固。但我认为我们正在与其他方（比如说市场中的竞争对手）合作，共同定义这些封装，并力求使客户能够在多源供应中完全安全地使用它们。

我：谢谢。我们已经讨论了不同的主题，从数据中心、GaN、设计、可靠性到封装。最后，Pietro，我想问最后一个问题。让我们看看数据中心之外还有什么应用。您如何看待GaN被引入其他市场？我指的是工业自动化，甚至是汽车，还有消费电子，当然还有快速充电器。那么，为了更广泛地应用GaN，需要满足哪些条件呢？

PS：当然。我认为很多分析师对这项技术给出了两位数的高估值，因为我们看到了它在不同市场的传播，对吧？就像我们说的，我们从消费物联网起步，现在我们看到它在数据中心基础设施和电源领域也大受欢迎。但我们在电机驱动、工业自动化，特别是交流驱动和机器人领域也有很多需求。通常情况下，高功率密度带来的是尺寸，这在所有这些应用中都很有吸引力。所以这要视具体情况而定，但只要你需要高功率密度，新技术就会成为一种强大的推动力，它可以在更小的空间内提供基本相同的效率，反之亦然，在相同的空间内提供更高的效率。我们也看到汽车行业发展迅速，尤其是在一些设备领域。因此，车载充电器（OBC）和直流/直流转换器（DC/DC）无疑是目标，对于分立元件来说也是如此，我们很快就看到了GaN的显著优势。我认为是拓扑增益，对吧？我们在汽车驾驶和工业自动化领域也看到了这一点。但具体到OBC，如果我们回顾一下最近的技术发展，就会发现双向开关绝对可以取代一些背靠背拓扑结构，例如在矩阵交流到直流的应用中，很容易用SIC来替代。而且这可以节省大量材料，因为基本上可以节省四倍，对吧？因为基本上一个器件在一个单片实现中集成了两个开关。当然，材料本身的成本会降低，但还有一个拓扑元素，也就是双向开关。所以非常热门。我的意思是，PCIM在我们展位上非常受欢迎，尤其是OBC上的电路板，因为我们已经展示了同类产品中相当的效率提升，所以吸引了许多客户参观。但正如我们所说，您可以根据系统需求将这种效率用于其他方面，反之亦然。如果减少散热，也可以节省成本。所以总的来说，我认为我们在不同的市场中看到了这种扩张趋势，这再次为设计人员提供了降低终端设备总体拥有成本的可能性，因为你可以通过不同的方式发挥效率，例如减少封装的侧面或使用相同的标准封装增加更高的密度。

我：确实，在 PCIM 大会上，这个主题在不同的展厅里讨论得非常好。非常感谢你，Pietro。对于宽带隙和 GaN 来说，这是一个激动人心的时刻。谢谢你。很棒的对话，请继续关注 PowerUP。下次再见。谢谢你，Pietro。

附言：谢谢你，Maurizio。感谢你邀请我们做客瑞萨。

<https://www.eetimes.com/podcasts/powering-the-ai-datacenter-renesas-and-the-age-of-gan/>

# 49. 下一场全球GaN专利战

作者 ：David Radulescu 博士； CS MANTECH 2025文章  

熟悉的战术，新一代的球员
GaN LED战争的教训
新兴的GaN IP军备竞赛
只有制定有针对性的专利战略的企业才能生存

全球GaN专利战卷土重来。这一次，战场从LED转向了功率晶体管。这场专利战的开场始于20世纪90年代末至21世纪初，当时日亚化学株式会社在东京起诉丰田合成，由此引发了一系列围绕GaN基LED技术的全球性、激烈的法律纠纷。这场旷日持久的冲突，以欧司朗光电半导体公司、科锐照明公司、Lumileds公司等公司相互提起的诉讼为标志，最终并未以最终的胜利告终，而是以全行业的疲惫和层出不穷的交叉许可协议告终。     

如今，半导体行业正处于一场可能引人瞩目的“后续”——GaN功率器件专利战的初期。这场新的争斗聚焦于增强型GaN晶体管——快速充电器、电动汽车和云数据中心的关键部件。与以往一样，这场诉讼跨越多个司法管辖区。也与以往一样，事关生死存亡。

熟悉的战术，新一代的球员
正如早期的 GaN LED 创新者奋力捍卫自己的突破一样，当今领先的 GaN 功率器件公司也在深入挖掘。

2023年，宜普电源转换公司（EPC）主动出击，在美国国际贸易委员会（ITC）和美国地方法院起诉Innoscience，指控其侵犯了四项所谓的基础专利。宜普电源转换公司声称Innoscience的产品非法盗用了其核心的硅基氮化镓晶体管技术。    

Innoscience 迅速作出反应，向专利审判和上诉委员会 (PTAB) 提起多方复审 (IPR) 申请，并在中国提起反诉，导致诉讼跨洲展开，诉讼结果好坏参半。EPC 在 ITC 开庭审理前放弃了两项专利，但凭借四项专利中的一项专利获得有限排除令，最终胜诉。随后，PTAB 于 2025 年 3 月宣布该专利的关键权利要求无效，但允许发布修改后的权利要求。双方都有胜诉，也有败诉，但这场战斗远未结束，上诉尚未开始。

2024年，这场战争开启了第二条战线。英飞凌在美国国际贸易委员会（ITC）和美国地方法院对英诺赛科提起诉讼，声称涉嫌侵犯四项与英诺赛科低压和高压HEMT产品线相关的专利。当英诺赛科证明被诉产品采用双增强模式场效应晶体管（FET）架构，而非英飞凌其中一项专利所要求的增强模式/去极化模式组合时，英飞凌从ITC案件中撤回了该专利，仅剩三项专利。  

与此同时，英飞凌在德国成功获得针对某些采用Innoscience封装产品的初步禁令。2025年初，Innoscience对英飞凌发起反攻，在中国提起诉讼，指控英飞凌侵犯其专利。由于诉讼正在美国专利审判与上诉委员会（PTAB）、美国国际贸易委员会（ITC）以及北美、欧洲和亚洲各地的法庭审理，这场第二次GaN专利战是一场真正的全球性冲突，并且正如ITC和德国法院发布的禁令所示，它将带来真正的商业后果。

GaN LED战争的教训
如果当前的冲突感觉似曾相识，那是因为我们之前就见过这种情况。在GaN LED时代，那些早期投资专利申请、积极诉讼并最终达成明智许可协议的公司，在2000年至2010年间，市场规模从10亿美元增长到100亿美元的同时，也成为了行业领导者。而那些没有这样做、等待太久或未能保护自身创新的公司，则在市场规模扩大后的头十年逐渐被淡出市场。

GaN LED领域的诉讼历史表明，这些专利战并非为了赢得每一场官司，而是为了在这场游戏中坚持足够长的时间，以塑造最终的许可格局。与过去一样，今天的纠纷很可能会最终导致新一轮的交叉许可，但只有那些拥有可靠专利组合和法律头脑的人才能在谈判桌上占有一席之地。

与此同时，专利策略不仅关乎技术实质，也关乎地点和时机。德国法院迅速批准了初步禁令救济，而美国法院则以审慎的节奏推进。中国国家知识产权局（CNIPA）已表明其愿意验证本地专利，尽管专利审判与上诉委员会（PTAB）对此表示怀疑。这场博弈的全球性要求跨国法律协调和深入的专利预见。

新兴的GaN IP军备竞赛
GaN功率市场即将爆发式增长，规模突破10亿美元。随着市场规模的增长，强大的专利地位的战略价值也随之增长。如今，法律纠纷围绕着极其具体的专利权主张展开：栅极架构、沟槽轮廓、外延成分。从数字如何标记端子到掺杂层是否符合“补偿”标准，看似微不足道的细节都可能左右数百万美元的决策。

在这些头条新闻的背后，一场更广泛的知识产权军备竞赛正在进行。许多公司正在积极准备参与其中，悄悄积累知识产权，谈判自由实施协议，并探索快速变化的市场格局。有些公司或许会避免公开冲突，但没有人能够承受措手不及的后果。在当今的GaN生态系统中，如果你不做好准备，就已经落后了。

结论：战争已然开始，只有制定有针对性的专利战略才能生存
下一场全球GaN专利战并非遥不可及，而是已经到来。EPC、Innoscience和英飞凌已率先发力。其他公司则在幕后暗中运作。游戏已然开启，只有做好充分准备的企业才能在未来十年GaN功率市场规模从10亿美元飙升至100亿美元的过程中生存下来。

要想赢得胜利，甚至长久生存，企业必须认真对待知识产权。这意味着构建知识产权组合时要考虑可执行性，采取全球行动，并汲取经验教训。GaN LED之争就是一个试验场。GaN的下一篇章也不例外。法律定位如今已成为竞争定位的核心。如果你涉足GaN领域，你就已经置身于这场战争之中。

您可以在此处下载完整的幻灯片：

<https://www.linkedin.com/feed/update/urn:li:activity:7330989118878793728>
